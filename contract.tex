...
%%
%% TODO: TWO COLLUMNS ON ASSIGMENT SECTION
%%
...
%% CLÁUSULA COMMAND
\newcommand{\clausula}{
                \addtocounter{clausula_number}{1}
                \section*{\hspace{-22pt} \textbf{CLÁUSULA  \arabic{clausula_number}º:}}\label{sec:Clausula\arabic{clausula_number}}}
...
\begin{document}
  ...
  %      \clausula TO doido todoido to doido tô doido
    %\section{CLAUSULA}\label{sec:clausula} oaisdoas
    %\section{CLAUSULA}\label{sec:clausula} oaisdoas
        %\section{\clausula}\label{sec:secondSection}
